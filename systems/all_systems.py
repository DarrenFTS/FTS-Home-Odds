...
HIST_ROI = {
    ...
    # Lay FHG U0.5 — verified, exclusive upper bound
    ("Brazilian Serie A",       1.50, 2.25, "Lay FHG U0.5"): 11.6,
    ...
    ("Scottish Premiership",    1.00, 2.00, "Lay FHG U0.5"): 13.2,
    # Back FHG O1.5 — verified
    ...
    ("Portuguese Primeira Liga",3.75, 4.50, "Home Lay"): 42.2,
    ("English League One",      3.75, 4.50, "Home Lay"): 24.9,
    ("Turkish Super Lig",       3.00, 4.00, "Home Lay"): 18.5,
    ("French Ligue 1",          5.00, 6.00, "Home Lay"): 28.8,
    ...
    ("Norwegian Tippeligaen",        2.00, 3.00, "Draw Lay"): 16.5,
    ("Spanish Primera Division",     1.75, 2.00, "Draw Lay"): 18.2,
    ("South Korean K League Classic",2.75, 3.00, "Draw Lay"): 32.1,
    ("English Championship",         2.75, 3.00, "Draw Lay"): 19.7,
    ("Belgian Premier League",       3.00, 3.75, "Draw Lay"): 15.4,
}
...
SYSTEM_DEFS = [
    ...
    },
    {
        ...
        "rules": [
            ...
            ("Scottish Premiership",    1.00, 2.00),
        ]
    },
    {
        "name": "Back FHG O1.5",
    ...
    },
    {
        ...
        "rules": [
            ...
            ("English Premier League",  2.00, 2.25),
    ...
    },
    {
        ...
        "rules": [
            ...
            ("Belgian Premier League",       3.00, 3.75),
        ]
    },
]
